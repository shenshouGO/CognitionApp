package com.example.administrator.getuitest.demo.ui.activity;
...
import com.example.administrator.getuitest.demo.receiver.AlarmReceiver;
import com.example.administrator.getuitest.demo.ui.fragment.AdvancedFunctionFragment;
import com.example.administrator.getuitest.demo.ui.fragment.AppInfoFragment;
import com.example.administrator.getuitest.demo.ui.fragment.HomeFragment;
...
public class GetuiSdkDemoActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public static final String MASTERSECRET = "kINn82fIED9DFCyWJANKH";
    private static final String TAG = "GetuiSdkDemoActivity";
...
//        setContentView(R.layout.getui_main);
    ...
    private void checkNotificationEnabled() {
        ...
        Log.e(TAG, "is notification enabled: " + isEnabled);
        if (!isEnabled) {
            goSetting();
        }
    }
...
//        tabHome = (FrameLayout)findViewById(R.id.home_frame);
//        tabHome.setOnClickListener(this);
//        tabAdvancedFunction = (FrameLayout)findViewById(R.id.advanced_function_frame);
//        tabAdvancedFunction.setOnClickListener(this);
//        tabAppInfo = (FrameLayout)findViewById(R.id.app_info_frame);
