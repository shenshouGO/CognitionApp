...
import com.example.administrator.getuitest.demo.receiver.AlarmUtils;
import com.example.administrator.getuitest.demo.ui.presenter.AuthInteractor;
import com.example.administrator.getuitest.demo.ui.presenter.HomePresenter;
...
//        }
    ...
    private void showToast(String content) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.BASE) {//9.0以上toast直接用原生的方法即可，并不用setText防止重复的显示的问题
