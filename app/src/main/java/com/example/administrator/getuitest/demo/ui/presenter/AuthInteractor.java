package com.example.administrator.getuitest.demo.ui.presenter;

import android.text.TextUtils;
import android.util.Log;

import com.example.administrator.getuitest.demo.config.Config;
import com.example.administrator.getuitest.demo.net.RetrofitManager;
...
public class AuthInteractor implements BaseInteractor {
    ...
    public void fetchAuthToken(final IAuthFinished authFinished) {
        if (TextUtils.isEmpty(Config.appkey) || TextUtils.isEmpty(Config.MASTERSECRET)) {
