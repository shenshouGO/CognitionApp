...
import com.example.administrator.getuitest.demo.ui.AdvancedFunctionDetailsProxy;
import com.example.administrator.getuitest.demo.ui.activity.AdvancedFunctionDetailsActivity;
...
public class AdvancedFunctionFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = null;
//        view = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_advanced_function, container, false);
        initViews(view);
        return view;
    }
